...
def sliding_window_inference(
    ...
    **kwargs: Any,
    ...
    """
    compute_dtype = list(predictor.module.named_parameters())[0][1].dtype
    ...
    # print("inferer.py @133", num_spatial_dims, inputs.shape, image_size_)
    if device is None:
    ...
    for slice_g in tqdm(range(0, total_slices, sw_batch_size)) if progress else range(0, total_slices, sw_batch_size):
        ...
        for ss, seg_prob in enumerate(seg_prob_tuple):
            ...
            resizer = Resize(spatial_size=seg_prob.shape[2:], mode="trilinear", anti_aliasing=False)
